 ...
 */
public class FormDiarioSup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        controladorCmb = new javax.swing.JComboBox();
        ...
        supervisorLabel.setText("Controlador:");

        controladorCmb.setEnabled(false);
        ...
        jMenuItem3.setText("Atualizar Controladores");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(controladorCmb, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addGap(14, 14, 14)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(controladorCmb, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(supervisorLabel))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel7)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Object objControlador = this.controladorCmb.getSelectedItem();
        ...
        if (objControlador == null & this.controladorCmb.isEnabled()) {
        ...
        String controlador = objControlador != null ? objControlador.toString() : "";
        DAOSupervisor SupervisorDAO = new DAOSupervisor();
        ...
        try {
            ...
            Ocorrencia.setSupervisor(SupervisorDAO.getNome(this.usuario));
            Ocorrencia.setUf(uf.toString());
            Ocorrencia.setSegmento(segmento.toString());
            Ocorrencia.setControlador(controlador);
            ...
            SupervisorDAO.registrarOcorrencia(Ocorrencia);
            atualizaDiario();
            limpar();
    ...
    private void ocorrenciaCmbItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ocorrenciaCmbItemStateChanged
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED & FormDiarioSup.iniciado) {
            ...
            if (ocorrencia.equals("ATESTADO MÉDICO") | ocorrencia.equals("AUSENTE PERÍODO")
                ...
                this.controladorCmb.setEnabled(true);

            } else {

                this.controladorCmb.setEnabled(false);
    ...
    private void atualizaOcorrencias() {
        ...
        try {
            ...
            List ocorrencias = DAOOcorrencia.getOcorrenciasGestao();
            for (int i = 0; i <= ocorrencias.size() - 1; i++) {

                Map obj = (Map) ocorrencias.get(i);
                this.ocorrenciaCmb.addItem(obj.get("OCORRENCIA"));
    ...
    private void atualizaDiario() throws SQLException, ClassNotFoundException {
        ...
        DAOOcorrencia DAOOcorrencia = new DAOOcorrencia();
        ArrayList<OcorrenciaSupervisor> ocorrencias = DAOOcorrencia.getOcorrenciaPorSupervisor(this.getUsuario());
        Object[] colunaNomes = {"UF", "SEGMENTO", "CONTROLADOR", "OCORRENCIA", "PERIODO","OBSERVAÇÃO"};
        ...
        for (OcorrenciaSupervisor ocorrencia : ocorrencias) {
            ...
            Object[] valores = {ocorrencia.getUf(),ocorrencia.getSegmento(), ocorrencia.getControlador(), ocorrencia.getOcorrencia(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDiarioSup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormDiarioSup().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox controladorCmb;
