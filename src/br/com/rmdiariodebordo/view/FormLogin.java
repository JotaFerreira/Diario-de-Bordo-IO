...
import br.com.rmdiariodebordo.model.bo.Autenticacao;
import br.com.rmdiariodebordo.model.dao.ControladorDAO;
import br.com.rmdiariodebordo.model.dao.PontoDAO;
...
import br.com.rmdiariodebordo.model.dao.SetorDAO;
...
//        }
    ...
    private void ufCmbItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ufCmbItemStateChanged
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            ...
            try {
                ...
                SetorDAO DAOSetores = new SetorDAO();
                ArrayList<Setor> setores = DAOSetores.getSetoresPorUF(uf);
                for (Setor s : setores) {
                    Object[] linha = {s.getNomeSetor(), Boolean.FALSE};                    
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (Autenticacao.autorizado(Usuario)) {
                ...
                switch (cargo) {
                    case "CONTROLADOR": {
                        ...
                        FormDiarioCon frm = new FormDiarioCon();
                        frm.setUsuario(user);
                        frm.setUf(uf);
                    ...
                    case "SUPERVISOR": {
                        FormDiarioSup frm = new FormDiarioSup();
                        frm.setUsuario(user);
                        frm.setVisible(true);
                        break;
                    }
                    case "COORDENADOR": {
                        FormDiarioCoo frm = new FormDiarioCoo();
                        frm.setUsuario(user);
                        frm.setVisible(true);
                        break;
                    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (nmPerfil != null) {
            ...
            try {
                ...
                if (new PontoDAO().inserirPerfil(novoPerfil)) {
    ...
    private void perfilCmbItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_perfilCmbItemStateChanged
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED & iniciado) {
            ...
            if (!nmPerfil.isEmpty()) {
                ...
                ArrayList<Ponto> horarios = new PontoDAO().getHorariosPorPerfil(nmPerfil);
    ...
    void senhas() throws Exception {
        ...
        ControladorDAO c = new ControladorDAO();
    ...
    private void carregaPerfis() {
        ...
        ArrayList<Ponto> perfis = new PontoDAO().getNomesPerfis();
